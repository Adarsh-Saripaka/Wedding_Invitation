...
export default function Events() {
  const events = [
    ...
    },
    {
      ...
      venue: 'Lucky Mansion Resort and Restaurant',
      venueAddress: 'Adivivaram - Boddunaidupalem Rd, Sowbhagya Rayapuram, Andhra Pradesh 531173',
      ...
      calendarEvent: {
        ...
        location: 'Lucky Mansion Resort and Restaurant, Andhra Pradesh',
      },
